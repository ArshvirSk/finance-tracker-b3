...
// Using Props for transactions is not necessary here since we are using context
// function Dashboard({ transactions }) {

// Using context to access transactions directly
function Dashboard() {
  ...
  useEffect(() => {
    const calculateStats = () => {
      ...
      const thisMonthTransactions = transactions.filter(
        (t) => new Date(t._id).getMonth() === currentMonth
      );
      const lastMonthTransactions = transactions.filter(
        (t) => new Date(t._id).getMonth() === lastMonth
      );
                ...
                stats.recentTransactions.map((transaction) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {new Date(transaction._id).toLocaleDateString()} —
                        {new Date(transaction._id).toLocaleTimeString()}
                      </p>
                    </div>
                    <div
